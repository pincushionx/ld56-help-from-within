...
public partial class @Input: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Merge"",
                    ""type"": ""Button"",
                    ""id"": ""63a3a0e1-3a2f-4a42-a16f-d30f08a9e206"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""ec03a315-bc6d-42b9-9464-63a9dd0f23e8"",
                    ""path"": ""<Keyboard>/enter"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""9186ec2b-ca6f-4420-8e7a-9f1999648a5c"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Bot_Merge = m_Bot.FindAction("Merge", throwIfNotFound: true);
        // Flow
    ...
    ~@Input()
    {
        Debug.Assert(!m_Bot.enabled, "This will cause a leak and performance issues, Input.Bot.Disable() has not been called.");
        Debug.Assert(!m_Flow.enabled, "This will cause a leak and performance issues, Input.Flow.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Bot_Merge;
    public struct BotActions
    {
        ...
        public InputAction @Merge => m_Wrapper.m_Bot_Merge;
